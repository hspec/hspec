...
-- import           Test.Hspec.Core.Config.Definition (addExtensionOptions)
...
{-
    context "with --tags" $ do
      let parseOptions args = snd <$> Options.parseOptions (addExtensionOptions "hspec-tags" [tagsOption] defaultConfig) "my-spec" [] Nothing [] args

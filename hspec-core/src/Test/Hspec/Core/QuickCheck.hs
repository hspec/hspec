...
modifyMaxSuccess :: (Int -> Int) -> SpecWith m a -> SpecWith m a
...
modifyMaxDiscardRatio :: (Int -> Int) -> SpecWith m a -> SpecWith m a
...
modifyMaxSize :: (Int -> Int) -> SpecWith m a -> SpecWith m a
...
modifyMaxShrinks :: (Int -> Int) -> SpecWith m a -> SpecWith m a
...
modifyArgs :: (Args -> Args) -> SpecWith m a -> SpecWith m a
